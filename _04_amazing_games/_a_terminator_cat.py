...
if __name__ == '__main__':
    ...
    left_eye = Eye(eye=background64, x=-53, y=6, radius=30)
    right_eye = Eye(eye=background64, x=43, y=-5, radius=30)
    background64.hideturtle()
